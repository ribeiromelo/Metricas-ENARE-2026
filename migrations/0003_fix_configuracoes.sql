-- ====================================================
-- CORRIGIR CONSTRAINT DA TABELA CONFIGURACOES
-- ====================================================

-- Remover constraint que limitava id = 1
-- SQLite não suporta ALTER TABLE para modificar constraints
-- Então precisamos recriar a tabela

-- 1. Criar tabela temporária sem a constraint
CREATE TABLE IF NOT EXISTS configuracoes_new (
  ...
  ciclo_gerado INTEGER DEFAULT 0,
